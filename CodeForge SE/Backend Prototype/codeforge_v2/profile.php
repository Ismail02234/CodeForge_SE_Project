...
// Fetch the user's recent submissions (with problem titles via JOIN)
$subStmt = $pdo->prepare("
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border-0 text-center mb-4">
                <div class="card-body py-5">
                    ...
                    <p class="text-muted small">User ID: <?= htmlspecialchars($user['id']) ?></p>
                    <span class="badge bg-primary px-3 py-2"><?= htmlspecialchars($user['rank'] ?? 'Newbie') ?></span>
                </div>
            </div>
            <div class="card shadow-sm border-0">
                <div class="card-body text-center">
                    <h6 class="text-uppercase small text-muted mb-1">Current Rating</h6>
                    <h2 class="fw-bold mb-1"><?= (int)$user['rating'] ?></h2>
                    <h6 class="text-uppercase small text-muted mb-1">Quests Solved</h6>
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white fw-bold">
                    <i class="bi bi-clock-history"></i> Recent Submissions
                </div>
                                ...
                                <?php foreach ($submissions as $sub): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="badge <?= $badge ?>"><?= htmlspecialchars($sub['verdict']) ?></span>
                                        </td>
            ...
            <div class="card shadow-sm border-0 mt-4">
                <div class="card-header bg-white fw-bold">
                    <i class="bi bi-award text-warning"></i> Badge Case
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        ?>
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="card text-center h-100 <?= $earned ? 'border-warning' : 'border-secondary opacity-50' ?>">
                                    <div class="card-body py-3">
                                        <i class="bi <?= htmlspecialchars($badge['icon']) ?> h1 <?= $earned ? 'text-warning' : 'text-muted' ?>"></i>
