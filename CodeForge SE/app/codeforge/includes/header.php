...
<div class="app-shell">
    <aside class="sidebar" id="sidebar" aria-label="Primary navigation">
        ...
        <nav class="sidebar-nav">
            ...
            <a class="feature-link <?= in_array($current, ['ghost_race.php', 'ghost_race_play.php'], true) ? 'active' : '' ?>" href="ghost_race.php"><i class="bi bi-ghost"></i>Ghost Race <span>NEW</span></a>
