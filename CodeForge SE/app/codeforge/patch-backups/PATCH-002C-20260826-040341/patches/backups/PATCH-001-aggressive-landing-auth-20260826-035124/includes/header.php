...
<head>
    ...
    <title><?= e($pageTitle) ?> Â· CodeForge</title>
...
<div class="app-shell">
    <aside class="sidebar" id="sidebar">
        <a class="brand" href="index.php"><span class="brand-mark">&lt;/&gt;</span><span>CodeForge</span></a>
        <div class="sidebar-section">Workspace</div>
        <nav class="sidebar-nav">
            <a class="<?= $current==='index.php'?'active':'' ?>" href="dashboard.php"><i class="bi bi-grid-1x2"></i>Dashboard</a>
    ...
    <main class="main-panel">
        <header class="topbar">
            ...
            <form class="global-search" action="search.php" method="get"><i class="bi bi-search"></i><input name="q" placeholder="Search users, problems, universitiesâ€¦" autocomplete="off"></form>
