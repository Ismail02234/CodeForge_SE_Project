...
require_once __DIR__ . '/SqlJudgeService.php';
...
final class SqlBattleService
{
    ...
    public function challenges(): array
    {
        return $this->pdo->query(
            "SELECT sc.*,
                    (SELECT COUNT(*) FROM sql_attempts sa WHERE sa.challenge_id = sc.id AND sa.status = 'accepted') AS accepted_attempts
