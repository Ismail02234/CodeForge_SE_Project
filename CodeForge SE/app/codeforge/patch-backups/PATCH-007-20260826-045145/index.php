...
try {
    ...
    if ($liveStats) {
        $stats['users'] = (int) $liveStats['users'];
        $stats['problems'] = (int) $liveStats['problems'];
        $stats['submissions'] = (int) $liveStats['submissions'];
    }
} catch (Throwable $e) {
    // The public landing page remains available even if a statistic cannot load.
}
?>
<!doctype html>
<html lang="en">
